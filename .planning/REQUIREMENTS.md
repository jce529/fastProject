...
- [x] **INFRA-01**: CombatController의 기존 Overclock(F.I.O.R.A) 로직이 IPlayerCombatModule 인터페이스로 무손상 마이그레이션된다 (기존 동작 100% 동일, 회귀 없음) — 코드 완료 2026-07-22, 실플레이 검증 완료 2026-07-28
...
- [x] **INFRA-03**: BossEnemy.cs에서 BossEnemyBase(EnemyBase와 별개의 형제 클래스)가 추출되어, 이후 신규 보스 4종이 이를 상속한다 — 코드 완료 2026-07-22, 실플레이 검증 완료 2026-07-28
...
|-------------|-------|--------|
| INFRA-01 | Phase 18 | Done (code 2026-07-22, playtest-verified 2026-07-28) |
