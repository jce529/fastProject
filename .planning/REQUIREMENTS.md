...
- [ ] **BOSS-04**: 보스는 7회 피격 시 처치되며, 매 피격 후 공격 패턴이 처음부터 다시 시작된다
- [ ] **BOSS-05**: 보스 처치 진행률(피격 횟수)은 플레이어에게 노출되지 않는다 (의도적 숨김)
- [ ] **BOSS-06**: 보스 처치 시 점수 보너스가 지급된다 (ScoreManager 연동)
...
- [ ] **SFX-01**: 기본 오디오 재생 인프라(AudioManager)가 추가된다 (현재 프로젝트에 오디오가 전혀 없음)
