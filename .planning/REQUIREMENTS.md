...
- [ ] **MOVE-01**: 플레이어가 빠른 속도로 좌우 이동 및 점프할 수 있다 (가속감 있음, 조작 즉각 반응, 공중 방향 제어 가능)
- [ ] **MOVE-02**: 낙사 시 사망하지 않고 마지막으로 밟은 플랫폼 위치로 복귀하며, 복귀 직후 짧은 무적이 부여된다
- [ ] **MOVE-03**: 별도 버튼으로 구르기가 발동된다 — 구르기 중 무적 판정, 쿨타임 있음, 슬로우 모션 중에도 사용 가능

### 전투 (Combat)

- [ ] **ATCK-01**: 게임 시작 전 직선형 / 부채꼴형 공격 타입을 선택할 수 있다 (단순 버튼 2개)
