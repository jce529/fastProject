...
See D:/새 폴더/Projeect_A.E/Projeect_A.E/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using D:/새 폴더/Projeect_A.E/Projeect_A.E/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using D:/새 폴더/Projeect_A.E/Projeect_A.E/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from D:/새 폴더/Projeect_A.E/Projeect_A.E/.claude/get-shit-done/templates/discovery.md
...
Use D:/새 폴더/Projeect_A.E/Projeect_A.E/.claude/get-shit-done/templates/discovery.md.
