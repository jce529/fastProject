...
- **Global scope**: `D:/새 폴더/Projeect_A.E/Projeect_A.E/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/새 폴더/Projeect_A.E/Projeect_A.E/.claude/notes/`)
...
2. Glob `D:/새 폴더/Projeect_A.E/Projeect_A.E/.claude/notes/*.md` (if directory exists) — global notes
...
Global (D:/새 폴더/Projeect_A.E/Projeect_A.E/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/새 폴더/Projeect_A.E/Projeect_A.E/.claude/notes/` — works in any directory
