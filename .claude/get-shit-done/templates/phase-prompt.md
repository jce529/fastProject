...
<!-- For checkpoint task examples and patterns, see @D:/새 폴더/Projeect_A.E/Projeect_A.E/.claude/get-shit-done/references/checkpoints.md -->
...
See `D:/새 폴더/Projeect_A.E/Projeect_A.E/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/새 폴더/Projeect_A.E/Projeect_A.E/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/새 폴더/Projeect_A.E/Projeect_A.E/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
