...
- Usage: Reference from command with `@D:/새 폴더/Projeect_A.E/Projeect_A.E/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/새 폴더/Projeect_A.E/Projeect_A.E/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/새 폴더/Projeect_A.E/Projeect_A.E/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
