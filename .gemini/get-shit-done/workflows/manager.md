...
```bash
INIT=$(node "D:/새 폴더/Projeect_A.E/Projeect_A.E/.gemini/get-shit-done/bin/gsd-tools.cjs" init manager)
...
Steps:
1. Read the plan-phase workflow: cat D:/새 폴더/Projeect_A.E/Projeect_A.E/.gemini/get-shit-done/workflows/plan-phase.md
2. Run: node \"D:/새 폴더/Projeect_A.E/Projeect_A.E/.gemini/get-shit-done/bin/gsd-tools.cjs\" init plan-phase {N}
...
Steps:
1. Read the execute-phase workflow: cat D:/새 폴더/Projeect_A.E/Projeect_A.E/.gemini/get-shit-done/workflows/execute-phase.md
2. Run: node \"D:/새 폴더/Projeect_A.E/Projeect_A.E/.gemini/get-shit-done/bin/gsd-tools.cjs\" init execute-phase {N}
